...
const BeautyRegister = () => {
  ...
  const handleVerify = async (e) => {
    ...
    try {
      ...
      navigate("/forgot-password"); // chuyển hướng tới trang đăng nhập
    } catch (error) {
        ...
        <div className="relative w-full h-64 md:h-full rounded-2xl overflow-hidden shadow-xl">
          ...
          <div className="absolute bottom-8 left-8 text-white">
            ...
            <p className="text-sm md:text-base">
              Đăng ký để khám phá vẻ đẹp đích thực
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-xl overflow-hidden">
          ...
          <div className="bg-gradient-to-r from-pink-400 to-purple-500 p-6 text-center">
            ...
            <p className="text-pink-100 mt-1">
              Gia nhập cộng đồng Vani Cosmestic
            </p>
          </div>
