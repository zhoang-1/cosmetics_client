                          ...
                          <div className="grid__item box-boder float-left min-h-[1px] pl-[30px] align-top  w-[100%] pl-[5px]">
                            <div className="product-item overflow-hidden relative">
                              <div className="product-img overflow-hidden relative">
                                <Link to={product.link} className='block text-black no-underline bg-transparent'>
                                  <img
                                ...
                                <div className="product-actions text-center after:content[''] after:table after:clear-both">
                                  <Link className="product-link absolute top-0 left-0 w-[100%] h-[100%] z-[3] text-black" to={product.link}></Link>
                              ...
                              <div className="product-item-info text-center p-[10px]">
                                <div className="product-title ">
                                  <Link to={product.link} className='inline-block text-[14px] leading-[21px] text-neutral-400 h-[38px] font-bold uppercase hover:text-black'>{product.name}</Link>
                                </div>
